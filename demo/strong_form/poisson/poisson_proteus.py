"""poisson-proteus.py [options]

Solves the Heterogeneous Poisson equation on a unit cube.
"""
...
from proteus_defaults import ProteusProblem, ProteusNumerics
from proteus_optparser import get_prog_opts
